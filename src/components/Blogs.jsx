...
const Blogs = () => {
    return (
        <section
            id="blogs"
            className="relative select-none scroll-mt-[10vh] py-20 px-6 sm:px-12 lg:px-24 bg-white dark:bg-neutral-800 transition-colors duration-500 overflow-hidden"
        >
            ...
            <div className="max-w-[1280px] mx-auto relative z-10">
                    ...
                    {blogPosts.map((post, index) => (
                        ...
                        >
                            ...
                            <div className="p-8 flex flex-col h-full relative overflow-hidden">
                                ...
                                <p className="text-neutral-600 dark:text-neutral-400 text-sm font-mulish mb-6 line-clamp-3 leading-relaxed">
                                    {post.description}
                                </p>

                                <div className="mt-auto pt-4 flex items-center justify-between border-t border-neutral-200 dark:border-neutral-800">
                ...
                >
                    <a
                        href="https://hashnode.com/@omteja04"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-8 py-3 bg-neutral-900 dark:bg-white text-white dark:text-black font-bold font-mulish rounded-full hover:bg-blue-500 dark:hover:bg-blue-500 hover:text-white dark:hover:text-white transition-all duration-300"
                    >

...
const FloatingResumeButton = () => {
    ...
    return (
        <motion.a
            ...
            className="group  hover:shadow-orange-500/20  fixed bottom-15 right-6 z-50 flex items-center bg-orange-400 text-white  font-bold pl-3 py-2 rounded-full shadow-lg overflow-hidden cursor-pointer"
        >
            {/* File Icon */}
            <svg
